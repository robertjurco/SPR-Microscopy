...
class CameraFPSController:
    ...
    def __init__(self, model, project_view, serial = '24514092'):
        ...
        self.worker_thread = CameraWorkerThread(self.camera, FPS_averaging = 10.0)

        self.worker_thread.fps_updated.connect(self.on_fps_measurement)
    ...
    def on_fps_measurement(self, fps):
